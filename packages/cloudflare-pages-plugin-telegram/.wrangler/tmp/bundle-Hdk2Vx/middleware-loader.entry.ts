...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/home/jack/repos/vampa/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/home/jack/repos/vampa/packages/cloudflare-pages-plugin-telegram/.wrangler/tmp/bundle-Hdk2Vx/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/home/jack/repos/vampa/packages/cloudflare-pages-plugin-telegram/.wrangler/tmp/bundle-Hdk2Vx/middleware-insertion-facade.js";
